...
<style>
    ...
    .stApp p, .stApp div, .stApp label, .stApp span, .stApp input, .stApp textarea, .stApp select {
...
<div class="system-footer">
    ...
    <p style="font-size:10px;">系統版本 v37.0 - DOM 穩定與完美內收排版</p>
</div>
""", unsafe_allow_html=True)
